...
import CRYPTOAPI from './ecp.cryp.js'
...
export const logintools = {
        ...
        .then(res => {
          if (res.data != null) {
            if (res && res.data.tokenid) {
			  //utils.setCookie("ecp_token", res.data.tokenid);
  ...
  firstLoginChangePW (userName, oldPsw, newPsw) {
    ...
    let oldPswEn = CRYPTOAPI.secEncrypt(oldPsw)
    let newPswEn = CRYPTOAPI.secEncrypt(newPsw)
